...
def load_arguments(self, _):
    ...
    with self.argument_context('lock') as c:
        ...
        c.argument('resource_name', options_list=('--resource-name'), help='Name of the resource being locked.')
    ...
    with self.argument_context('resource lock') as c:
        c.argument('resource_group', resource_group_name_type, id_part=None)
        c.argument('resource_name', options_list=('--resource-name'), validator=validate_resource_lock)
