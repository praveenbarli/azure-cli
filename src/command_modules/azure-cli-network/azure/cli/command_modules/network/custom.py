...
def remove_dns_aaaa_record(cmd, resource_group_name, zone_name, record_set_name, ipv6_address,
    ...
    record = AaaaRecord(ipv6_address=ipv6_address)
    record_type = 'aaaa'
    return _remove_record(cmd, record, record_type, record_set_name, resource_group_name, zone_name,
...
def _remove_record(cmd, record, record_type, record_set_name, resource_group_name, zone_name,
